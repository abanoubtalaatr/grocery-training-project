@php
    ...
    $pageTitle = View::yieldContent('page-title') ?: ($isRtl ? __('app.dashboard') : __('app.default_title'));
@endphp
...
<header class="bg-white border-b border-gray-100 sticky top-0 z-40" dir="{{ $isRtl ? 'rtl' : 'ltr' }}">
    ...
    <div class="flex items-center justify-between px-6 h-16">
        ...
        <div class="flex items-center gap-2">
            ...
            {{-- Search --}}
            <button
                class="w-9 h-9 flex items-center justify-center rounded-lg text-gray-500 hover:bg-gray-100 hover:text-gray-700 transition-colors">
            ...
            <div class="relative">
                ...
                <span
                    class="absolute top-1.5 {{ $isRtl ? 'left-1.5' : 'right-1.5' }} w-2 h-2 bg-emerald-500 rounded-full ring-2 ring-white"></span>
            </div>
            ...
            <button class="flex items-center gap-2.5 px-3 py-1.5 rounded-lg hover:bg-gray-100 transition-colors group">
                ...
                <span
                    class="text-sm font-medium text-gray-700 group-hover:text-gray-900">{{ Auth::user()->name }}</span>
