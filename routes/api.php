...
use App\Http\Controllers\Api\V1\ApiOffersController;
use App\Http\Controllers\Api\V1\ApiReviewController;
/*
|--------------------------------------------------------------------------
| API Routes
|--------------------------------------------------------------------------
...
Route::prefix('v1')->group(function () {
    ...
    Route::get('/offers', [ApiOffersController::class, 'index']);
