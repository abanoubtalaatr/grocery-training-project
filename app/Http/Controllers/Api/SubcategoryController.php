...
class SubcategoryController extends Controller
{
    ...
    {
        $subcategory->load(['category', 'meals' => function ($query) {
        ...
        return response()->json([
            ...
            'data' => [
                ...
                'meals' => MealResource::collection($subcategory->meals),
     ...
     */
    public function meals(Subcategory $subcategory, Request $request): JsonResponse
    {
